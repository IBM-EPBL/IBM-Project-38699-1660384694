...
st.sidebar.info("[Kaggle : admissions_predict](https://www.kaggle.com/datasets/rishal005/admission-predict/code?resource=download)")
st.sidebar.subheader('Author Credits')
st.sidebar.info("[Shubhadeepa Sahu](https://github.com/shubha262)\
    \n [Sharmila L](https://github.com/Sharmi1820)\
    \n [Rufina B](https://github.com/Rufina123)\
    \n [Modi Yuva Chaitanya](https://github.com/yuvachaitanya28)")
